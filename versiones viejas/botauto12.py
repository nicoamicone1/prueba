...
def obtener_señal_efectiva():
    try:
        ...
        for tf_interval, peso in zip(TIMEFRAMES, PESOS):
            ...
            if df is not None:
                df = calcular_indicadores_completos(df)
                # Utilizamos el análisis LSTM con umbral actualizado en 2%
        ...
        # Umbral configurado a 3 para señales
        if puntaje_total >= 3:
            return 'BULLISH'
...
def analizar_con_lstm(df):
    try:
        ...
        # Se exige una diferencia mínima del 2% para la proyección
        umbral_lstm = 0.02
        ...
        while True:
            ...
            if señal != 'NEUTRAL' and precio is not None:
                ...
                if posicion is None:
                    ...
                    # Si ya hay posición en el mismo sentido, simplemente actualizamos las órdenes
